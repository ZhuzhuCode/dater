...
/**
 * Created by zhujr on 2018/9/19.
 * 根据图片和文字生产自定义图片
 */
public class ChartGraphics {
    private BufferedImage image;
    private int imageWidth = 300;//图片宽度
    private int imageHeight = 500;//图片高度
    ...
    public static void main(String[] args) {
        ...
        try {
            cg.graphicsGeneration("ewew", "1", "12", "F:\\MySource\\pictures\\罗小黑打哈欠.gif");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }

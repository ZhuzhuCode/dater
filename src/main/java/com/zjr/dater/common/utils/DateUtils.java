...
public class DateUtils {
    ...
    public static String dateCommandTime(String date) {
        ...
        if (date == null || date.length() != 10 || !DateUtils.isRightDate(date, "yyyy-MM-dd")) {
            return null;
        }
     ...
     * @return
     */
    public static String localDateTimeToStrLong(LocalDateTime localDateTime){
        return dateToStrLong(localDateTimeToDate(localDateTime));
    }
     ...
     * @return
     */
    public static Timestamp getDateTimeStamp(String dateStr, String time){
        String nowDateStr = dateStr+time;
        return Timestamp.valueOf(nowDateStr);
    }
}
